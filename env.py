...
class Env():
    ...
    def observation(self):
        ...
        player_observation = self.window.size[0] * self.player.location[0] + self.player.location[1]
        ball_observation = self.window.size[0] * self.ball.location[0] + self.ball.location[1]
